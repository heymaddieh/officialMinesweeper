  ...
  this.Board = function (element) {
    ...
    this.traverse = function (zone) { //This function gives each box the view of all of the boxes around it using an array called zones, with all of the dimensions
      var zones = [];
  ...
  this.Zone = function (element, x, y) {
    this.element = element;
    this.x = x;
    this.y = y;
    this.isMine = false;
